from SELFRec_new import SELFRec
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu', '-i', required=True, help='GPU ID')
    args = parser.parse_args()
    os.environ["CUDA_VISIBLE_DEVICES"] = args.gpu

    models = {
        'Graph-Based Baseline Models': ['LightGCN', 'DirectAU', 'MF'],
        'Self-Supervised Graph-Based Models': ['SGL', 'SimGCL', 'SEPT', 'SSL4Rec', 'XSimGCL', 'VoteGCL'],
